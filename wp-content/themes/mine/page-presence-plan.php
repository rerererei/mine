...
<section class="second-top-text">
    ...
    <div class="osusume-square">
        ...
        <div class="pcview">
            <p style="font-size: 25px;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">少しでも手厚く弔ってあげたい</p>
            <p style="font-size: 25px;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">家族みんなでお別れをしたい</p>
            <p style="margin-top: 2rem;font-size: 25px;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 2rem auto;">霊園まで出向く時間のない方</p>
        </div>
        <div class="spview">
            <p style="font-size: 4vw;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">少しでも手厚く弔ってあげたい</p>
            <p style="font-size: 4vw;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">家族みんなでお別れをしたい</p>
            <p style="margin-top: 2rem;font-size: 4vw;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">霊園まで出向く時間のない方</p>
        </div>
    </div>
</section>
<section class="second-gray-area">
    ...
    <div class="img-area">
        <img class="pcview" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/images/presence-plan/presence-table.png"/>
        <img class="spview" src="<?php echo get_stylesheet_directory_uri(); ?>/resources/images/presence-plan/presence-table-sp.png"/>
    </div>
...
<section class="second-flow-area pcview">
    <h2 class="about-plan-text" style="padding-bottom: 0px;">葬儀の流れ</h2>
        ...
        <div class="plan-step">
            ...
            <div class="step-text">
                <p class="plan-step-text-sec">ペット葬祭MINE へお電話下さい。<br>ペットの種類や大きさ、お迎えのご希望日時などをご連絡ください。 お客様からお伝えいただいた情報をもとに日程と費用をお伝えします。</p>
        ...
        <div class="plan-step">
            ...
            <div class="step-text">
                <p class="step-text-sec">セレモニー車にて個別火葬を致します。
                </p>
            </div>
        </div>
        <div class="plan-arrow-tri">
...
<section class="second-flow-area spview">
    <h2 class="about-plan-text" style="padding-bottom: 0px;">葬儀の流れ</h2>
        <p class="plan-step-title">1. お電話</p>
        <div class="plan-step">
            <div class="step-text">
        ...
        <div class="plan-step">
            <div class="step-text">
                ...
                <p class="plan-step-text-sec">ペット葬祭MINEへご来場ください。<br>※駐車場を完備していますので、お車でご来場可能です。
                </p>
            </div>
        </div>
        <div class="plan-arrow-tri">
        ...
        <div class="plan-step">
            <div class="step-text">
                ...
                <p class="plan-step-text-sec">セレモニー車にて個別火葬を致します。
                </p>
            </div>
        </div>
        <div class="plan-arrow-tri">
