...
<section class="second-top-text">
    ...
    <div class="osusume-square">
        ...
        <p style="font-size: 25px;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">霊園へお参りをしてあげたい方</p>
        <p style="font-size: 25px;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 0 auto;">ご遺骨をご自宅などに置けない方</p>
