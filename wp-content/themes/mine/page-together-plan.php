...
<section class="second-top-text">
    ...
    <div class="osusume-square">
        ...
        <div class="spview">
            ...
            <p style="margin-top: 1rem;font-size: 4vw;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">ご遺骨をご自宅などに置けない方</p>
            <p style="margin-top: 1rem;font-size: 4vw;color: #00214A;border-bottom: solid 1px #00214A;width: fit-content;margin: 1rem auto;">他の動物たちと一緒に供養をしてあげたい方</p>
        </div>
    </div>
</section>
