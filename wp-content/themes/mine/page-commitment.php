...
<section class="commitment-content">
    ...
    <div class="commitment-content-row-blue">
        ...
        <div class="commitment-content-text">
            ...
            <p class="commitment-text">環境にやさしく、様々な火葬炉基準を<br>クリアしたダイオキシンを発生させない<br>「無煙・無臭、無公害構造 」でご近所に<br>配慮し火葬車に社名をいれていません。</p>    
        </div>
    ...
    <div class="commitment-content-row">
        <div class="commitment-content-thought">
            <a href="/mine/thought/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/resources/images/banner-thought.webp"></a>
        </div>
